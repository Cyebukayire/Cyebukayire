...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=tokyonight&size=35&center=true&vCenter=true&width=1000&lines=HELLO+THERE!;+I+SPECIALIZE+IN+WEB+DEVELOPMENT,;SOFTWARE+TESTING+AND+DEVOPS.;I'M+INTERESTED+IN+AI+AND+MACHINE+LEARNING;;4+YEARS+OF+PROGRAMMING;THNX+:%29)](https://git.io/typing-svg)
...
Currently using Js, Vuejs, React, and focusing on DevOps, Math and Physics
